 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link userService.service.impl.UsersLocalServiceImpl}.
 * </p>
 *
 * @author Yevgen Kogut
...
public abstract class UsersLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements UsersLocalService, IdentifiableBean {
    @BeanReference(type = userService.service.UsersLocalService.class)
    protected userService.service.UsersLocalService usersLocalService;
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link userService.service.UsersLocalServiceUtil} to access the users local service.
     */
    ...
    @Override
    public Users addUsers(Users users) throws SystemException {
        users.setNew(true);
    ...
    public Users createUsers(long userId) {
        return usersPersistence.create(userId);
    }
    ...
    public Users deleteUsers(long userId)
        ...
        return usersPersistence.remove(userId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Users deleteUsers(Users users) throws SystemException {
    ...
    @Override
    public Users fetchUsers(long userId) throws SystemException {
        return usersPersistence.fetchByPrimaryKey(userId);
    }
     ...
     */
    @Override
    public Users getUsers(long userId) throws PortalException, SystemException {
        return usersPersistence.findByPrimaryKey(userId);
    }
     ...
     */
    @Override
    public List<Users> getUserses(int start, int end) throws SystemException {
     ...
     */
    @Override
    public int getUsersesCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Users updateUsers(Users users) throws SystemException {
        return usersPersistence.update(users);
    }
     ...
     */
    public userService.service.UsersLocalService getUsersLocalService() {
    ...
    public void setUsersLocalService(
        userService.service.UsersLocalService usersLocalService) {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("userService.model.Users",
            usersLocalService);
    }
