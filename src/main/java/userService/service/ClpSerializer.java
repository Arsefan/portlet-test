...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "portlet-test2-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "portlet-test2";
            }
    ...
    public static Object translateInputUsers(BaseModel<?> oldModel) {
        UsersClp oldClpModel = (UsersClp) oldModel;

        BaseModel<?> newModel = oldClpModel.getUsersRemoteModel();
    ...
    public static Object translateOutputUsers(BaseModel<?> oldModel) {
        ...
        newModel.setUsersRemoteModel(oldModel);
